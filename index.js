...
function lint(webpackInstance, input, options) {
    ...
    report(result, emitter, options.failOnHint, options.fileOutput, webpackInstance.resourcePath, bailEnabled, options.canEmit);
}

function report(result, emitter, failOnHint, fileOutputOpts, filename, bailEnabled, canEmit) {
